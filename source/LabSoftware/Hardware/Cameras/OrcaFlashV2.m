...
classdef OrcaFlashV2<Camera
    ...
    methods
        function obj=OrcaFlashV2()
            ...
            warning("If you want to use the Hammamatsu OrcaFlashV2, you have to install the following:" + ...
                    "* DCAM-API driver (https://www.hamamatsu.com/jp/en/product/cameras/software/driver-software.html" + ...
                    "* to be able to use the camera in MATLAB, the Hamamatsu Hardware Support Package has to be installed in Matlab (https://de.mathworks.com/matlabcentral/fileexchange/45078-image-acquisition-toolbox-support-package-for-hamamatsu-hardware)." + ...
                    "* to use the DCAM-API you can also use Micromanager (https://micro-manager.org/) or the HoKaWo software from Hammamatsu.");
